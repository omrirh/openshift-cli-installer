...
class UserInput:
    def __init__(self, **kwargs):
        ...
        self.azure_tenant_id = self.user_kwargs.get("azure_tenant_id")
        self.azure_client_id = self.user_kwargs.get("azure_client_id")
        self.azure_client_secret = self.user_kwargs.get("azure_client_secret")
        self.azure_subscription_id = self.user_kwargs.get("azure_subscription_id")
